...
namespace Homework.Pages
{
    public partial class RegistrationPage : BasePage
    {
        ...
        public IWebElement RadioButtons => Wait.Until(d => d.FindElement(By.Id("id_gender1")));
        ...
        public string errorMessageFirstName => Driver.FindElement(By.XPath("//*[@id='center_column']/div/ol/li[1]/b")).Text;
                                                                            
        public string errorMessageLastName => Wait.Until(d => d.FindElement(By.XPath("//*[@id='center_column']/div/ol/li[1]/b"))).Text;
        
        public string errorMessagePassword => Driver.FindElement(By.XPath("//*[@id='center_column']/div/ol/li[1]/b")).Text;

        public string errorMessageCity => Driver.FindElement(By.XPath("//*[@id='center_column']/div/ol/li[1]/b")).Text;
        
        public string errorMessageZip => Driver.FindElement(By.XPath("//*[@id='center_column']/div/ol/li[1]")).Text;

        public string errorMessageExpectedFirstName => "firstname";

        public string errorMessageExpectedLastName = "lastname";

        public string errorMessageExpectedPassword = "passwd";

        public string errorMessageExpectedCity = "city";

        public string errorMessageExpectedZip = "The Zip/Postal code you've entered is invalid. It must follow this format: 00000";
